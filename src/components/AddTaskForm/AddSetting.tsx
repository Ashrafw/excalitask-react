      ...
      <div className="mt-2 text-sm">
        ...
        <div className=" grid grid-cols-3 gap-y-2 gap-x-2 text-sm items-center">
          <button
            ...
            }  rounded shadow p-1 px-2 bg-zinc-100`}
          >
            Font Style
          </button>
          <button
            ...
            }  border rounded shadow p-1 px-2 bg-zinc-100`}
          >
            Font Style
          </button>
          <button
      ...
      <div className="mt-2  border-t-zinc-700 border-t-2">
        ...
        <div className=" grid grid-cols-3 gap-y-2 gap-x-2 text-sm mt-2 items-center">
          <button
            ...
            className={` border rounded shadow p-1 px-2 bg-zinc-100  ${
          ...
          <button
            ...
            className={`w-  border rounded shadow p-1 px-2 bg-zinc-100  ${
