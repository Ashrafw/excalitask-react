  ...
  return (
    <div className="relative">
      <button
        ...
        className={` p-2 flex shadow-sm justify-center items-center rounded bg-white text-gray-700  hover:bg-slate-100 text-2xl`}
      >
        <IoInvertMode />
      </button>
      {isOpen ? (
          ...
          <div>
            ...
            <div className=" flex  gap-2 items-center">
              <button
                ...
                className={` w-12 h-10 bg-white rounded shadow-md  ${
